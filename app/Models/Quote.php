...
class Quote extends Model
{
    ...
    protected $fillable = [
        ...
        'payment_method', 'amount_paid', 'paid_at', 'is_courtesy', 'review_token', 'review_requested_at', 'notified_stages', 'external_reference', 'cancelled_at', 'cancel_reason',
